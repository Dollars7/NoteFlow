...
const storageKey = "noteflow-memory-v2";
...
export default function Home() {
  ...
  }, [cardMemory, deletedCardIds, evidence, generatedCards, generatedNotes, goalProfile, hasRestored, skills]);
